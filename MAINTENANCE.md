...
El criterio fundamental es: **se acepta software que da soporte específico a Aragón, no software hecho por alguien de Aragón.**

Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Aragón. No basta con que el autor resida o trabaje aquí. Un framework genérico creado por un developer de Aragón no pertenece a esta lista. Un cliente para la API de datos abiertos del gobierno de Aragón o una integración con servicios públicos de Aragón sí.

- **Sí:** Clientes de APIs de instituciones de Aragón, integraciones con servicios públicos regionales, scrapers de transporte o datos abiertos de Aragón.
- **No:** Librerías genéricas creadas por equipos de Aragón, software genérico cuyo autor simplemente reside en la comunidad.

Ver `AGENTS.md` (si existe) para criterios detallados adicionales.

## Revisar PRs

1. Comprobar que el proyecto **da soporte específico a Aragón** (no simplemente que el autor es de Aragón).
2. Verificar que la PR incluye la **URL del servicio o institución de Aragón** que el proyecto soporta.
...
4. Si el propietario del proyecto no ha sido notificado, abrir un issue de cortesía en su repo:
   - Título: `Incluido en awesome-aragon`
...
| No cumple criterios de inclusión | Eliminados por no ser específicos de Aragón |
