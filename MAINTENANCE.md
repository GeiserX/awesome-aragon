...
Un repositorio se incluye porque interactúa con instituciones, servicios, infraestructura, normativas o datos propios de Aragón. No basta con que el autor sea de Aragón o resida aquí. Un framework genérico creado por un developer de Aragón no pertenece a esta lista. Un cliente para una API de servicios de Aragón sí.
