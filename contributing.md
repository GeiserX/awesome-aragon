...
- El proyecto debe **dar soporte específico a Aragón** o incluir funcionalidades relevantes para usuarios en esta comunidad autónoma.
...
5. **Incluye en la descripción de la PR la URL del servicio, API o institución aragonesa** a la que el software da soporte (p.ej. aragon.es, unizar.es, zaragoza.es). Esto ayuda a verificar que el proyecto es relevante para Aragón.
